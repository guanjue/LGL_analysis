...
cCRE_bed_file_start=$(echo $cCRE_bed_file | awk -F '.' '(NF=NF-1) 1')

### RNA file (bed information at column $5,$6,$7,$2,$3,$8)
RNA_TPM_file='HumanVISION_RNAseq_hg38_genes_tpm.txt'
RNA_TPM_file_start=$(echo $RNA_TPM_file | awk -F '.' '(NF=NF-1) 1')

### 
All_RNA_gene_file_start='HumanVISION_RNAseq_hg38_genes'
